...
public class EntitySkeletonSoldier extends EntityEventSkeleton
{
	public EntitySkeletonSoldier(World world) 
	{
		super(world);
	...
	{
		this.bookDescription = "A common Skeleton soldier.";
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
	{
		...
		this.setCustomNameTag("Skeleton Soldier");
		return livingdata;
	}
}
