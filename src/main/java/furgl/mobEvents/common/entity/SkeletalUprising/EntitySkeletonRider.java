...
public class EntitySkeletonRider extends EntityEventSkeleton
{
	...
	public void setBookDescription() {
		this.bookDescription = "Rides a Skeleton Horse into battle.";
	...
	public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
		...
		this.setCustomNameTag("Skeleton Rider");
