...
public class EntityZombieBard extends EntityEventZombie
{
	/**Is color increasing or decreasing*/
	private boolean increasing;
	private boolean playedRecord;
	
	public EntityZombieBard(World world) 
	{
		super(world);
	...
	public void onUpdate()
	{
		...
		if (this.ticksExisted % 100 == 0)
		{
			...
			for (EntityEventZombie zombie : zombies)
				if (!(zombie instanceof EntityZombieBard))
	...
	{ 
		...
		this.setItemStackToSlot(EntityEquipmentSlot.MAINHAND, new ItemStack(list.get(rand.nextInt(12))));
