...
public class GuiButtonIntroPage extends GuiButton
{	
	...
	public GuiButtonIntroPage(int buttonId, int x, int y, int width, int height, String buttonText, GuiEventBook book)
	{
